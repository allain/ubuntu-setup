...
sudo apt update -y
sudo apt install -y fish curl wget git ripgrep gnupg unzip xz-utils glab gh gnome-shell-extension-manager wl-clipboard xclip direnv just cloc glow fzf htop
